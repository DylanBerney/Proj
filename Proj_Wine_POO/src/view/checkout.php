            ...
            <div class="col-md-6 mb-5 mb-md-0">
                ...
                <div class="p-3 p-lg-5 border">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <label for="postal_zip" class="text-black">Posta / Zip <span
                                    class="text-danger">*</span></label>
                ...
                <div class="row mb-5">
                    <div class="col-md-12">
                        ...
                        <div class="p-3 p-lg-5 border">
                            ...
                            <label for="code" class="text-black mb-3">Enter your coupon code if you have
                                one</label>
                        ...
                        <div class="p-3 p-lg-5 border">
                            ...
                            <div class="form-group">
                                    ...
                                    <label class="input-medium">
                                        ...
                                        <button class="btn" type="submit">Place
                                            Order</button>
